    ...
    def singleLinkageDist(self, other):
        ...
        for selfPoint in self.points:
            for otherPoint in other.points:
                dist = selfPoint.distance(otherPoint)
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        # TO DO
        newClusterPoints = c1.points + c2.points
        newCluster = Cluster(newClusterPoints, type(c1.points[0]))
        self.add(newCluster)
    ...
    def findClosest(self, linkage):
        ...
        # TO DO
        distances = []
        minDist = linkage(self.members[0], self.members[1])
